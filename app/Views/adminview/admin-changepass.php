...
<div class="container-fluid">
  <div class="row" style="padding-bottom: 13px !important; ">
    <div class="col-12">
      <div class="card-custom card px-4" style="height:95.3vh !important;">
          ...
          <form method="post">
            <div class="col-md-4 m-auto">
              ...
              <div class="row m-auto">
                <button type="submit" name="update-password-admin" class="btn btn-primary mt-3">Update Password</button>
