      ...
      <div class="card-custom card">
        <div class="row mx-3">
          <div class="Heading-page">
            <h4><i class="fa fa-user mx-2"></i>Update User MSO</h4>
          </div>
        </div>

        <?php $id = $mso['MSO_id']; ?>
        <form method="post" action="<?php echo base_url(); ?>/UpdateUser/<?= $id ?>">
          <input type="hidden" name="id-user" value="mso">
          <div class="update-sm row mx-5 mt-5">
            <div class="row mb-1">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="" class="LabelUser">Firstname</label>
                  <input type="text" placeholder="Firstname" name="firstname" value="<?= $mso['firstname'] ?>" class="form-customize form-control">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" placeholder="Lastname" name="lastname" value="<?= $mso['lastname'] ?>" class="form-customize form-control">
                  <?php if (isset($validation)) : ?>
            ...
            <div class="row mb-1">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" placeholder="Address" name="address" value="<?= $mso['address'] ?>" class="form-customize form-control">
                  <?php if (isset($validation)) : ?>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" placeholder="Contact Number" name="contact" value="<?= $mso['contact'] ?>" class="form-customize form-control">
                  <?php if (isset($validation)) : ?>
            ...
            <div class="row m-auto">
              <div class="form-register col-md-4">
                <input class="form-check-input" type="checkbox" value="1" name="checkusername" id="user_check" style="margin-top:11px;">
                <label class="form-check-label" for="flexCheckDefault" style="margin-top:13px;">
                  <em>Check to update username</em>
                </label>
              </div>

              <div class="form-register col-md-4">
                <input class="form-check-input" type="checkbox" value="1 " name="checkpassword" id="pass_check" style="margin-top:11px;">
            ...
            <div class="row mb-1">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" placeholder="Username" name="username" value="<?= $mso['username'] ?>" class="form-customize form-control">
                  <?php if (isset($validation)) : ?>
            ...
            <div class="row mt-5 d-flex justify-content-end button-update-sm">
              ...
              <div class="col-md-2 mx-3 ">
                <a href="<?php echo base_url(); ?>/ManageMSO"><button type="button" name="update-cancel" class="btn btn-danger btn-sm px-5 mx-3">Cancel</button></a>
              </div>
              <div class="col-md-2">
