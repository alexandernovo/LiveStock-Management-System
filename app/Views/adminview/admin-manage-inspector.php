              ...
              <tbody>
                <?php foreach ($viewuser as $viewResult) : ?>
                  <tr>
                    ...
                    <td><a href="<?php echo base_url(); ?>/UpdateInspector/<?= $viewResult['Inspector_id'] ?>"><button class="btn-viewdetails-mso btn btn-primary btn-sm"><i class="view-user fa fa-edit" style="margin-right:4px;"></i>Update</button></a></td>
                    <td>
                      <div class="row m-auto">
                        <?php if ($viewResult['status'] == 0) { ?>
                          <a href="<?php echo base_url(); ?>/activateInspector/<?= $viewResult['Inspector_id']; ?>" class="btn-viewdetails-mso btn btn-success btn-sm px-0" style="color: white !important;"><i class="fa fa-power-off"></i> Activate</a>
                        <?php } else { ?>
                          <a href="<?php echo base_url(); ?>/deactivateInspector/<?= $viewResult['Inspector_id']; ?>" class="btn-viewdetails-mso btn btn-danger btn-sm px-0" style="color: white !important;"><i class="fa fa-power-off"></i> Deactivate</a>
                        <?php } ?>
                      </div>
                    </td>
                  </tr>
