        ...
        <div class="row">
          <div class="button-view row">
            <div class="button-container p-0">
              <a href="<?php echo base_url(); ?>/Register"><button class="btn btn-primary bg-gradient-primary btn-view float-end mt-3">Register User</button></a>
            </div>
          </div>
              ...
              <tbody>
                <?php foreach ($viewuser as $viewResult) : ?>
                  <tr>
                    ...
                    <td><a href="<?php echo base_url(); ?>/UpdateMSO/<?= $viewResult['MSO_id']; ?>"><button class="btn-viewdetails-mso btn btn-primary btn-sm"><i class="view-user fa fa-edit"></i> Update</button></a></td>
                    <td>
                      <div class="row m-auto">
                        <?php if ($viewResult['status'] == 0) { ?>
                          <a href="<?php echo base_url(); ?>/activateMSO/<?= $viewResult['MSO_id']; ?>" class="btn-viewdetails-mso btn btn-success btn-sm px-0" style="color: white !important;"><i class="fa fa-power-off"></i> Activate</a>
                        <?php } else { ?>
                          <a href="<?php echo base_url(); ?>/deactivateMSO/<?= $viewResult['MSO_id']; ?>" class="btn-viewdetails-mso btn btn-danger btn-sm px-0" style="color: white !important;"><i class="fa fa-power-off"></i> Deactivate</a>
                        <?php } ?>
                      </div>
                    </td>
                  </tr>
