...
<head>
  ...
  <title>Department of Agriculture Inspector</title>
  <style>
...
<body class="users-body">
      ...
      <div class="collapse collapse-customize navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
          <li class="nav-items nav-item">
            <a class="nav-linkster nav-link" aria-current="page" href="<?php echo base_url(); ?>/inspector"><i class="icons-navbar-user fa fa-home"></i>Home</a>
          </li>
          <li class="nav-items nav-item">
            <a class="nav-linkster nav-link" href="<?php echo base_url(); ?>/InspectorSchedulesperDate?filter=All&date_from=<?php echo date('Y-m-d') ?>&date_to=<?php echo date('Y-m-d', strtotime('+7 days')) ?>"><i class="icons-navbar-user fa fa-calendar"></i>Schedule</a>
          </li>
          <li class="nav-items nav-item">
            <a class="nav-linkster nav-link" href="<?php echo base_url(); ?>/InspectorHistory?filter=All&date_from=<?php echo date('Y-m-d') ?>&date_to=<?php echo date('Y-m-d', strtotime('+7 days')) ?>"><i class="icons-navbar-user fa fa-history"></i>History</a>
          </li>
          <li class="nav-items nav-item">
            <div class="dropdown show">
              ...
              <div class="droped dropdown-menu" aria-labelledby="dropdownMenuLink">
                <a class="drop-me dropdown-item" href="<?php echo base_url(); ?>/ManageProfileInspector"><i class="icons-navbar-user fa fa-cog"></i>Account Settings</a>
  ...
  <script>
    ...
    var title = "<?= session()->get('Inspector_firstname') ?>";
  </script>
