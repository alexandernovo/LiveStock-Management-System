        ...
        <div class="card-body px-3 py-1">
          <table class="table table-dashboard table-striped">
            ...
            <tbody>
              ...
              <?php endif; ?>
              <?php foreach ($mso_today_sched as $row) : ?>
                <tr>
                  <td><?= $row->firstname . ' ' . $row->lastname ?></td>
                  <td><?php echo date('M d, Y h:i:s a', strtotime($row->schedule_datetime)) ?></td>
                  <td><a href="<?php echo base_url(); ?>/MSOHistoryDetails/<?= $row->index_id ?>?filter=All" class="btn btn-primary btn-sm px-4 mb-0 text-light text-bold"><i class="fa fa-info-circle"></i> View</a></td>
                </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
